      ...
      <Card className="w-full max-w-4xl">
        <CardContent className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Button
              variant="default"
              className="h-40 text-xl flex-col gap-2 rounded-lg shadow-lg transform transition-transform hover:scale-105 whitespace-normal"
            ...
            <Button
              variant="secondary"
              className="h-40 text-xl flex-col gap-2 rounded-lg shadow-lg bg-accent text-accent-foreground hover:bg-accent/90 transform transition-transform hover:scale-105 whitespace-normal"
            ...
            <Button
              variant="outline"
              className="h-40 text-xl flex-col gap-2 rounded-lg shadow-lg transform transition-transform hover:scale-105 border-primary text-primary hover:bg-primary/5 whitespace-normal"

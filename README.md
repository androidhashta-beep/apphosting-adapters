...
### Step 1: Deploy the App to a Server

This project is designed for deployment with **Firebase App Hosting**, which is the recommended method. You do not need to run a build command locally.

**How it Works:**
1.  You connect your source code repository (e.g., a GitHub repository) to your Firebase project.
2.  Whenever you push new code to your repository, Firebase automatically builds and deploys the new version of your application for you. Your app will then be live at the URL provided by Firebase.
...
### Step 2: Install the App on Your PCs
...
Whenever you deploy a new version (Step 1), the installed apps on your PCs will automatically download the update in the background. The next time a user closes and re-opens the app, it will be the new version.

      ...
      <header className="bg-primary shadow-lg">
        <div className="container mx-auto flex h-20 items-center justify-center px-4 md:h-24 md:justify-start">
          <div className="flex items-center gap-4">
            <img src="https://irp.cdn-website.com/39392137/dms3rep/multi/opt/logo-6f4e825a-396w.png" alt="Renaissance Training Center Inc. Logo" width={64} height={64} className="object-cover" />

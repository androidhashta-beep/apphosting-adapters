...
export const initialStations: Station[] = [
  { id: 'enrollment-1', name: 'Registrar Window 1', type: 'enrollment', status: 'open', mode: 'regular', currentTicketId: null },
  { id: 'enrollment-2', name: 'Registrar Window 2', type: 'enrollment', status: 'open', mode: 'regular', currentTicketId: null },
